...
#ifdef CLIENT_DLL
#define CWeapon92fs C_Weapon92fs
#endif
...
class CWeapon92fs : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS(CWeapon92fs, CBaseHL2MPCombatWeapon);
...
private:
	CWeapon92fs(const CWeapon92fs &);
};

IMPLEMENT_NETWORKCLASS_ALIASED(Weapon92fs, DT_Weapon92fs)

BEGIN_NETWORK_TABLE(CWeapon92fs, DT_Weapon92fs)
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA(CWeapon92fs)
...
LINK_ENTITY_TO_CLASS(weapon_92fs, CWeapon92fs);
PRECACHE_WEAPON_REGISTER(weapon_92fs);
